...
@endpush
        <div class="sent_reports border p-4  ">
            ...
            <div class="row sraction mb-4">
                <form action="{{url('/hospital/all-reports/')}}" class="row sraction">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center mb-2"><a href="{{url('/hospital/all-reports')}}" class="btn btn-danger">Cancel Filter</a></div>                    
                @endif
            </div>
