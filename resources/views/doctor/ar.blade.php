@extends('doctor.main')
@push('title')
<title>All Reports || Medical Report Meker</title>
@endpush
@section('content')
        ...
        <div class=" sent_reports border p-4 ">
            ...
            <div class="row sraction mb-4">
                <form action="{{url('/doctor/all-reports/')}}" class="row sraction">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center mb-2"><a href="{{url('/doctor/all-reports')}}" class="btn btn-danger">Cancel Filter</a></div>                    
                @endif
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="m-0 d-flex justify-content-around border-0">
                                ...
                                <a href="{{url('/doctor/edit-report/'.$item['rid'] )}}"><span role="button"><img src="{{asset('/assets/image/edit.png')}}" alt="Edit"></span></a>
                                <a href="{{url('/doctor/print/'.$item['rid'])}}"><span role="button"><img src="{{asset('/assets/image/print.png')}}" alt="print"></span></a>                               
