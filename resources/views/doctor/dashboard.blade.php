            ...
            <div class="">
                <div class="row g-5 m-0 text-center">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <a href="{{url('/doctor/recived-reports')}}" class="text-dark">
                        <div class="px-3 py-5 border">
                            <h1>{{$rr}}</h1>
                            <h6>Number of Received Reports</h6>
                        </div>
                        </a>
                    </div>

                    <div class="col-lg-4 col-md-4">
                        <a href="{{url('/doctor/complete-reports')}}" class="text-dark">
                        <div class="px-3 py-5  border">
                            <h1>{{$cr}}</h1>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <a href="{{url('/doctor/all-reports')}}" class="text-dark">
                        <div class="px-3 py-5  border">
                            <h1>{{$tr}}</h1>
