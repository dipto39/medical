@extends('doctor.main')
@push('title')
<title>Add Report Format || Medical Report Meker</title>
@endpush
@section('content')
<div class="add_report_format border p-2">
    <form id="nrform" action="{{url('/doctor/'.$url)}}" method="post" class="py-1 px-2 ">
        @csrf
        <div class="row gx-5 px-5">
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control" name="title" id="rftitle"
                            aria-describedby="helpId" placeholder="" value="{{isset($format) ? $format['title'] : old('title') }}" required>
                    </div>
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-8">
                        <textarea name="details" id="rfdetails" cols="" rows="4"
                            class="form-control">{{isset($format) ? $format['details'] : old('details') }} </textarea>
                    </div>
                    <span class="text-danger">
                        @error('details')
                        {{$message}}    
            ...
            <div class="col-md-12 col-lg-6 ps-lg-5">
                <div class="form-group row mb-5">
                    ...
                    <div class="col-8">
                        <select class="form-select" name="department" id="rfdep" {{($btn == 'Update') ? "disabled" : ""}} >
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-8">
                        <select class="form-select" name="type" id="rftype" {{($btn == 'Update') ? "disabled" : ""}} >
                            @if (isset($type))
            ...
            <div class="col-12 text-end">
                <a href="{{url('/doctor/report-formats')}}" type="button" class="btn me-4 py-1 px-3 btn-danger">Cancel</a>
